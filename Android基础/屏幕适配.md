...
dip和具体像素值的对应公式是dip值 =设备密度/160* pixel值，可以看出在dpi（像素密度）为160dpi的设备上1px=1dip,在Android中，规定以160dpi为基准，1dip=1px，如果密度是320dpi，则1dip=2px，以此类推。
...
分辨率对应DPI      像素密度范围      
HVGA    mdpi     120dpi-160dpi 
WVGA    hdpi     160dpi-240dpi     
720P    xhdpi    240dpi-320dpi   
1080P   xxhdpi   320dpi-480dpi
