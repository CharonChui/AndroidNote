...
class Solution {
    fun isIsomorphic(s: String, t: String): Boolean {
        ...
        val s2tHash = HashMap<Char, Char>()
        val t2sHash = HashMap<Char, Char>()

        for (i in s.indices) {
            val a = s[i]
            val b = t[i]

            if (s2tHash.contains(a)) {
                if (s2tHash[a] != b) {
                    return false
                }
            } else {
...
- [下一题](https://github.com/CharonChui/AndroidNote/blob/master/Algorithm/41.单词规律.md)
