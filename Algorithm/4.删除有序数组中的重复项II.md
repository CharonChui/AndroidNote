...
一定要注意： 这里比较的是 nums[i] != nums[k - 2], 而不能是i - 2。

因为i中的元素会被后面的覆盖掉，会变。 比较i - 2是不对的，而k - 2才是去重后的真实结果。 


- [下一篇](https://github.com/CharonChui/AndroidNote/blob/master/Algorithm/5.%E5%A4%9A%E6%95%B0%E5%85%83%E7%B4%A0.md)
